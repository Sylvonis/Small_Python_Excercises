...
# with text characters. The (0, 0) origin is in the upper-left corner, the x-coordinates increase
...
# a newline. Then your program should print grid[0][1], then grid[1][1], then grid[2][1], and
# so on. The last thing your program will print is grid[8][5].
#
